...
import { AuthNavigationProp } from 'navigation/Auth.navigation'
  ...
  return (
    ...
    >
      <View style={tw`flex-1`}>
        ...
        >
          <Text style={tw`text-lg font-bold mb-4`}>Privacy Terms</Text>
          <Text style={tw`mb-4 leading-6 text-gray-700`}>
