...
with_node \
  ...
  --target "/Users/wadsonvaval/code_prods/vwanu-app/ios/Pods/Target Support Files/Pods-vwanuapp/ExpoModulesProvider.swift" \
  --entitlement "/Users/wadsonvaval/code_prods/vwanu-app/ios/vwanuapp/vwanuapp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-eas-client" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-secure-store" "expo-updates"
